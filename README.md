...
**Difficulty:** 9/10 &middot; **Task type:** CV semantic segmentation
...
```bash
git clone https://github.com/Sandyyy123/liora-10-severstal-steel.git
cd liora-10-severstal-steel
